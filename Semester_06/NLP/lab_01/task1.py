...
eng = [
    ...
    "Obama gave this really good address at the UN back in 2015 or something.",
    "We went to that new Thai place on Market Street and the food was mid honestly.",
    "Tesla stock dropped like 8 percent after Musk made that weird post.",
    "I forgot to buy milk at Lidl and now I have to go back tomorrow morning.",
    "The professor cancelled the exam and gave us a project instead, so now I'm stuck on the first draft.",
...
ro = [
    ...
    "Am vazut un film pe HBO Max aseara, dar titlul mi-a scapat complet.",
    "La Cluj s-a deschis un restaurant nou langa Piata Unirii si e destul de bun.",
    "Colegul meu de camera a mancat tot ce era in frigider si a lasat doar o nota pe masa.",
    "Profesorul de la mate ne-a dat o nota despre cum se calculeaza nota finala si tot am ramas confuz.",
...
def process(sentences, nlp, has_chunks=True):
    for i, sent in enumerate(sentences):
        ...
        out(f"  pos: {[(t.text, t.tag_) for t in doc]}")

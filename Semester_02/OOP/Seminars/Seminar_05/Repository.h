...
class Repository {
 ...
 public:
  /*
          ...
          Initializes an object of type repository, by reading data from the
     given file. Throws: FileException - if the file cannot be opened.
  */
  ...
  */
  ...
  /*
          ...
          Throws: InexistenSongException - if there are no songs with the given
     artist and title.
  */
  ...
  /*
          ...
          Output: the song that was found, or an "empty" song (all fields empty
     and duration 0), if nothing was found.
  */
  Song findByArtistAndTitle(const std::string& artist,
